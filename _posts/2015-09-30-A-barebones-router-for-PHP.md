...
layout: post
category : project
tagline: "A barebones router for PHP. It matches urls and executes PHP functions. automatic get variable based on handler function parameter list"
tags : [router, micro, library]
---
{% include JB/setup %}
